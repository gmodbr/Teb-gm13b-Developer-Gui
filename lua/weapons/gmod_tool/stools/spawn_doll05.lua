...
TOOL.Name = "#Tool.spawn_doll05.name"
TOOL.Command = nil
TOOL.ConfigName = ""
TOOL.Information = {
    { name = "left" },
...
if CLIENT then
	language.Add("Tool.spawn_doll05.name", "Spawn doll-05")
	language.Add("Tool.spawn_doll05.desc", "Spawns doll-05")
	language.Add("Tool.spawn_doll05.left", "Spawn obj")
end

local function spawn_doll05(pos)
	if SERVER then
...
function TOOL:LeftClick(trace)
	spawn_doll05(trace.HitPos)
	return true
end

function TOOL.BuildCPanel(pnl)
	pnl:AddControl("Header",{Text = "#Tool.spawn_doll05.name", Description = "#Tool.spawn_doll05.desc"})
end