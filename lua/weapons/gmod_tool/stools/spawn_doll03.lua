...
TOOL.Name = "#Tool.spawn_doll03.name"
TOOL.Command = nil
TOOL.ConfigName = ""
TOOL.Information = {
    { name = "left" },
...
if CLIENT then
	language.Add("Tool.spawn_doll03.name", "Spawn doll-03")
	language.Add("Tool.spawn_doll03.desc", "Spawns doll-03")
	language.Add("Tool.spawn_doll03.left", "Spawn obj")
end

local function spawn_doll03(pos)
	if SERVER then
...
function TOOL:LeftClick(trace)
	spawn_doll03(trace.HitPos)
	return true
end

function TOOL.BuildCPanel(pnl)
	pnl:AddControl("Header",{Text = "#Tool.spawn_doll03.name", Description = "#Tool.spawn_doll03.desc"})
end