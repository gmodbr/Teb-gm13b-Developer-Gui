function C_GM13B_GUI_Panel:Fill_GM13B_SubTab_Main(GM13B_SubTab_Main)
  ...
  -- cough
  local cough_Button = vgui.Create("DButton")
  cough_Button:SetText("cough")
  cough_Button:Dock(TOP)
  cough_Button:DockMargin(0, 0, 0, 5)
  cough_Button:SizeToContents()
  cough_Button.DoClick = function ()
    net.Start("gm13_print_cough")
    net.Broadcast()
  end
  GM13B_SubTab_Main_List:AddItem(cough_Button)
 end